...
Create a histogram to examine the distribution `avg_ice_duration` and calculate summary statistics for the center and spread of the distribution. Include informative axis labels and an informative title on the visualization.
...
Create a histogram to examine the distribution of the `avg_air_temp` and calculate summary statistics for the center and spread of the distribution. Include informative axis labels and an informative title on the visualization.
...
-   Based on the visualizations of average ice duration and average air temperature over time, would you expect the slope of the linear model of the association between average ice duration and average air temperature to have a positive or negative slope? Briefly explain.

### Exercise 7

Researchers would like to use a linear model they can use to understand variability in the average ice duration based on the average air temperature. Write the form of the statistical model the researchers would like to estimate. Use mathematical notation and variable names (`avg_air_temp` and `ice_duration`) in the equation.[^1]
...
Fit and display the model described in the previous exercise. Use the `kable` function to neatly display the model output to three decimal places.

-   Write the equation of the fitted model. Use mathematical notation and variable names (`avg_air_temp` and `ice_duration`) in the equation.
...
-   First set a seed for simulating reproducibly. Use the see `10`.

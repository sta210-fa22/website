...
.pull-right\[ [-Wikipedia](https://en.wikipedia.org/wiki/Regression_analysis)\]
...
A - Introductory statistics or probability course <br>

.vocab\[Q - Will we be doing computing?\]

A - Yes. We will use the computing language R. <br>
...
-   .vocab\[Course website:\] [sta210-fa21.netlify.app](https://sta210-fa21.netlify.app/)

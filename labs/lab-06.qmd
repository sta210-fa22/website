...
-   Tuesday, November 98, 11:59pm (Friday labs)
:::
...
<!-- -->
```
-   What are the **odds** of a penguin being from the Adelie species if it was recorded on Dream island?

-   What are the **odds** of a penguin being from the Adelie species if it was recorded on Biscoe island?

### Exercise 5

Next, we'd like to add bill depth to the model. We'll start by examining the relationship between `bill_depth_mm` and `adelie`.

Visualize the relationship between these two variables. What is something you observe about the relationship between these two variables based on the plot?

### Exercise 6

-   Next, add bill depth to the previous model so that there are two predictors, `island` and `bill_depth_mm`. Neatly display the model output using three digits.

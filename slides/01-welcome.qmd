...
::: columns
::: {.column width="50%"}
![](images/w01/maria.png){fig-alt="Headshot of Maria Tackett" fig-align="center"}

::: center
**Dr. Maria Tackett (she/her)**
:::
:::
...
-   Go to the class Ed Discussion: [edstem.org/us/courses/8350/discussion/565405](https://edstem.org/us/courses/8350/discussion/565405) - UPDATE LINK
...
A - Yes and No. The course is primarily focused on application; however, we will discuss some of the mathematics of simple linear regression. There is a new 1-credit course [STA 211: Mathematics of Regression](https://stat.duke.edu/courses/mathematics-regression) to take simultaneously or after this course to dive into more of the mathematics.
...
-   **Course website**: [sta210-fa21.netlify.app](https://sta210-fa21.netlify.app/)
    -   Central hub for the course!
    -   **Tour of the website**
-   **Sakai**: [sakai.duke.edu](https://sakai.duke.edu)
    -   Gradebook
    -   Announcements
-   **Ed Discussion**: [edstem.org/us/courses/8350/discussion](https://edstem.org/us/courses/8350/discussion/)\]
    -   Class Q&A and discussion forums
...
::: columns
::: {.column width="50%"}
![](images/w01/rstudio.png){fig-alt="RStudio logo" fig-align="center" width="75%"}
:::
...
::: columns
::: {.column width="50%"}
![](images/w01/github.png){fig-alt="GitHub logo" fig-align="center" width="75%"}
:::
...
-   Read the [Course Support](../../support.qmd) page for more details
...
-   `r emo::ji("mask")` Wear a mask at all times in lectures and labs.
...
-   Read about them in the [syllabus](../../syllabus.qmd) and refer back to them as needed

## Collaboration & sharing code

-   We have policies!

-   Read about them in the [syllabus](../../syllabus.qmd) and refer to them as needed
...
See the [Course Support](../../support.qmd) page for information on Duke's academic and wellness resources.
...
-   Let's take a look at the [Movies budgets vs. revenues](https://sta210-fa21.netlify.app/appex/ae-01-movies.html) analysis. - Move to a GitHub repo
...
-   See [Week 01](../../weeks/week-01.qmd) on the schedule for lecture slides, assignments, and readings.

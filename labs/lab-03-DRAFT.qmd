...
# Meet your team! - UPDATE (maybe put the team agreement in a doc?)

[Click here](https://prodduke-my.sharepoint.com/:x:/g/personal/mt324_duke_edu/EYAMe-DTHh5BpK-R0rLvUNYBKrYc88n8COENMulIBS3pCw?e=PjyxHf) to see the team assignments for STA 210. This will be your team for labs and the final project.
...
# Exercises - Relationship between sweetness and flavor
...
5.  Next, let's examine if there are any points with standardized residuals that have large magnitude. Are there any such points in the data? If so, how many? Briefly explain, including any output, graphs, etc. you used to determine the response.
